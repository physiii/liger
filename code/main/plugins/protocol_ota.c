...
#define EXAMPLE_WIFI_SSID "HelloWorld"
#define EXAMPLE_WIFI_PASS "qscwdvpk"
#define EXAMPLE_SERVER_IP   "pyfi.org"
#define EXAMPLE_SERVER_PORT "80"
#define EXAMPLE_FILENAME "liger.bin"
			...
			void *user, void *in, size_t len)
{
    ...
    xTaskCreate(&ota_example_task, "ota_example_task", 8192, NULL, 5, NULL);
		//xTaskCreate(init_ota, "init_ota", 1024*3, &vhd, 10, NULL);
